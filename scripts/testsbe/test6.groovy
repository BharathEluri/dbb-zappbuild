...
def buildConf = "/u/adcde/poc-workspace/poc-app/scripts/testsbe/"
props.load(new File("${buildConf}/properties/test6.properties"))
...
compile.dd(new DDStatement().name("SYSLIN").dsn("${props.objdsn}(${props.member})").options("shr"))
...
link.dd(new DDStatement().name("SYSLIN").dsn("ADCDE.BUILD.OBJ(${props.member})").options("shr"))
